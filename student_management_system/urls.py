...
from student_management_app.views import view_subject_marks, get_results

urlpatterns = (
    [
        #path('subject_marks/', views.view_subject_marks, name='subject_marks'),
        path('get_results/', get_results, name='get_results'),
        path('subject_marks/<int:subject_id>/', views.view_subject_marks, name='subject_marks'),
        ...
        path("start_live_classroom", StaffViews.manage_student_marks, name="start_live_classroom"),
